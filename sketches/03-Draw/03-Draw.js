...
function keyPressed() {
  ...
  switch (
    ...
    case 82: //R (Next Sketch)
      window.location.href = "../04-flow-lines/04-flow-lines.html"; //redirect current page to sketch 1, a test sketch
      break;
    ...
    case 70: //F (Previous Sketch)
      window.location.href = "../02-emotion/02-emotion.html"; //~~~PLACEHOLDER, UPDATE~~~ redirect current page to sketch 0, the home menu
      break;
