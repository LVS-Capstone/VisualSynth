...
function mandala() {
  ...
  for (let j = layers; j > 0; j--) {
    ...
    let ly = j / 20;
    x1 = 222 * ly//random(185 * ly, 205 * ly);
    x4 = 240 * ly//random(230 * ly, 245 * ly);
    x2 = 100 * ly//random(190 * ly, 215 * ly);
    let maxX2 = x2 * tan(ang) * 0.9;
    y2 = 50 * ly//random(15 * ly, maxX2 * ly);
    x3 = 210 * ly//random(210 * ly, 230 * ly);
    y3 = 20 * ly//random(15 * ly, maxX2);
    let hue = 222//random(256);
    let sat = 80//random(70, 100);
    let brt = 70//random(70, 100);
    let alph = 50//random(40, 100);
